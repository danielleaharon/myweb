...
export default function SocialIcons(props) {
	...
	return (
		<div className='social-icons-links'>
			...
			<div className="link">
				<a className="icon-link whatsapp" rel="noopener noreferrer" href="https://api.whatsapp.com/send?phone=972545480180&text=Hi%20,%20i%20like%20your%20site%20" aria-label="whatsapp" target="_blank"><i className="fa fa-phone"></i> </a>
			</div>
		</div>
	);
}
